...
<feed>
  <entry>
    ...
    <title>v2.7.5</title>
    <link rel="alternate" type="text/html" href="https://github.com/ZMGID/Dsivio/releases/tag/v2.7.5"/>
  </entry>
  <entry>
    <link rel="alternate" type="text/html" href="https://github.com/ZMGID/Dsivio/releases/tag/v2.7.4"/>
  </entry>
</feed>"#;
