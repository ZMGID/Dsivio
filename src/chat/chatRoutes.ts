...
export function isChatMarketPath(path: string): boolean { return chatRouteKind(path) === 'market' }
  ...
  if (chatView === 'workbench') {
    ...
    if (path.startsWith('chat/workbench/')) {
      ...
      if (
        ...
        || item === 'workbench/posts'
        || item === 'workbench/articles'
        || item === 'workbench/main'
        || item === 'workbench/detail'
        || item === 'workbench/poster'
        || item === 'workbench/retouch'
        || item === 'workbench/migrate'
        || item === 'workbench/dress'
        || item === 'workbench/clone'
        || item === 'workbench/edit'
        || item === 'workbench/shorts'
        || item === 'workbench/avatar'
        || item === 'workbench/drama'
        || item === 'workbench/vclone'
        || item === 'workbench/vedit'
        || item === 'workbench/subs'
        || item === 'workbench/publish'
        || item === 'workbench/vaccts'
        || item === 'workbench/plogs'
        || item === 'workbench/pdata'
        || item === 'workbench/roles'
        || item === 'workbench/assets'
        || item === 'workbench/usage'
      ) return item
    }
    return 'workbench'
  }
